...
public class TableauTactile extends Composand3D
{
    ...
    private Boite creerH()
    {
        ...
        barGauche.finalize(LARGEUR*3, LARGEUR/2f, LARGEUR);
        ...
        barGauche.addChild(barTransversale.finalize(LARGEUR, barGauche.getHauteur(), LONGEUR - LARGEUR*2.5f*2));
        ...
        barGauche.addChild(barDroite.finalize(barGauche.getLargeur(), barGauche.getHauteur(), barGauche.getLongeur()));
    ...
    private Boite creerPied()
    {
        ...
        return b.finalize(LARGEUR, HAUTEUR_ECRAN * 1.25f, LARGEUR*2);
    }
    ...
    private Boite creerEcran()
    {
        ...
        return b.finalize(LARGEUR, HAUTEUR_ECRAN, LONGEUR);
    }
}
